package utils
{
  ...
  public class ColorUtils
  {
    ...
    public static function brightenColor(hexColor:Number, percent:Number=20):Number
    {
      if (isNaN(percent))
        percent = 0;
      if (percent > 100)
    ...
    public static function darkenColor(hexColor:Number, percent:Number=20):Number
    {
      if (isNaN(percent))
        percent = 0;
      if (percent > 100)
